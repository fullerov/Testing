...
var arr=url.split('/');
imagesDir = "http://"+arr[2]+"/js/icons/";

// CSS Directory
cssDir = "http://"+arr[2]+"/js/styles/";

// Popups Directory
popupsDir = "http://"+arr[2]+"/js/popups/";
...
//Name              buttonID                 buttonTitle           buttonImage                            buttonImageRollover
  ...
  "underline":      ['Underline',            'Подчеркивание',          imagesDir + 'underline.gif',          imagesDir + 'underline_on.gif'],
	"strikethrough":  ['Strikethrough',        'Перечеркивание',      imagesDir + 'strikethrough.gif',      imagesDir + 'strikethrough_on.gif'],
	"seperator":      ['',                     '',                   imagesDir + 'seperator.gif',          imagesDir + 'seperator.gif'],
	"subscript":      ['Subscript',            'Приписка',          imagesDir + 'subscript.gif',          imagesDir + 'subscript_on.gif'],
	"superscript":    ['Superscript',          'Надстрочный',        imagesDir + 'superscript.gif',        imagesDir + 'superscript_on.gif'],
	"justifyleft":    ['Justifyleft',          'Выравнивание лево',        imagesDir + 'justify_left.gif',       imagesDir + 'justify_left_on.gif'],
	"justifycenter":  ['Justifycenter',        'Выравнивание центр',      imagesDir + 'justify_center.gif',     imagesDir + 'justify_center_on.gif'],
	"justifyright":   ['Justifyright',         'Выравнивание право',       imagesDir + 'justify_right.gif',      imagesDir + 'justify_right_on.gif'],
	"unorderedlist":  ['InsertUnorderedList',  'Неупроядоченый список',imagesDir + 'list_unordered.gif',     imagesDir + 'list_unordered_on.gif'],
	"orderedlist":    ['InsertOrderedList',    'Упорядоченный список',  imagesDir + 'list_ordered.gif',       imagesDir + 'list_ordered_on.gif'],
	"outdent":        ['Outdent',              'Выдавливание',            imagesDir + 'indent_left.gif',        imagesDir + 'indent_left_on.gif'],
	"indent":         ['Indent',               'Вдавливание',             imagesDir + 'indent_right.gif',       imagesDir + 'indent_right_on.gif'],
  ...
  "paste":          ['Paste',                'Вставить',              imagesDir + 'paste.gif',              imagesDir + 'paste_on.gif'],
	"forecolor":      ['ForeColor',            'Цвет текста',          imagesDir + 'forecolor.gif',          imagesDir + 'forecolor_on.gif'],
	"backcolor":      ['BackColor',            'Цвет фона',          imagesDir + 'backcolor.gif',          imagesDir + 'backcolor_on.gif'],
	"undo":           ['Undo',                 'Отменить',               imagesDir + 'undo.gif',               imagesDir + 'undo_on.gif'],
	"redo":           ['Redo',                 'Повторить',               imagesDir + 'redo.gif',               imagesDir + 'redo_on.gif'],
	"insertimage":    ['InsertImage',          'Вставка изображения',        imagesDir + 'insert_picture.gif',     imagesDir + 'insert_picture_on.gif'],
	"createlink":     ['CreateLink',           'Ссылка',         imagesDir + 'insert_hyperlink.gif',   imagesDir + 'insert_hyperlink_on.gif'],
	"viewSource":     ['ViewSource',           'Исходный код',         imagesDir + 'view_source.gif',        imagesDir + 'view_source_on.gif'],
	"viewText":       ['ViewText',             'Текст',           imagesDir + 'view_text.gif',          imagesDir + 'view_text_on.gif'],
	"selectfont":     ['SelectFont',           'Ширифт',         imagesDir + 'select_font.gif',        imagesDir + 'select_font_on.gif'],
	"selectsize":     ['SelectSize',           'Размер',         imagesDir + 'select_size.gif',        imagesDir + 'select_size_on.gif']
};
...
function formatText(id, n, selected) {
  ...
  document.getElementById("wysiwyg" + n).contentWindow.focus();
	...
	if (viewTextMode == 1 && disabled_id == 1) {
	  alert ("Выбран вид текстового HTML! Данная функция недоступна, измените режим нажа на кнопку `TEXT`...");	
	}
