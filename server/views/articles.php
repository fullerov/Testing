...
<? 
//вывод спмска статей
if(is_array($this->content) and isset($this->count))
{ 
	$cnt='<center><p>Всего статей: <b>'.$this->count.'</b></p></center><table border="0" width="750">';
	foreach($this->content as $v)
		{
			$cnt.='<tr><td><a href="/articles/get/id/'.$v['id'].'">'.$v['title'].'</a></td></tr>'.
			'<tr><td><a href="/articles/get/id/'.$v['id'].'"><img src="'.$v['img'].'"></a></td></tr><tr><td><p>Добавил: <a href="mailto:'.Registration::getUserEmail($v['user_id']).'">'.Registration::getUserLogin($v['user_id']).'</a><br>Дата:  '.$v['date'].'<br> Оценка: '.$v['rating'].' Голосов: '.$v['votes'].'</p></td></tr>
			<tr><td id="list_txt">'.$v['meta_description'].'...<br><hr></td></tr>';
		}
