<!--Представление сотрудников организаций-->
...
<!--Вывод контента-->
<div id="content"><? 
//если пришел массив с данными о сотрудниках выводим форму для их редактирования
if(is_array($this->workers))
{
	require_once('editForms.php');
	echo getWorkersList($this->workers, $this->content, $this->organizations);
}
elseif(is_string($this->addworker))
{
	require_once('editForms.php');
	echo addWorker($this->addworker, $this->organizations);
}
else
	echo $this->content; 
