<!--Вид для вывода информации о школьниках-->
...
<div id="content">
<? 
//вывод информацию о школьниках добавленых пользователем
if(isset($this->mypupils) and isset($this->cities))
{	
	require_once('editForms.php');
	echo getMyPupils($this->mypupils, $this->cities);
}
//добавление нового ученика
elseif(isset($this->addpupil) and isset($this->cities))
{
	require_once('editForms.php');
	echo addNewPupil($this->addpupil, $this->cities);
}
//выводим данные о предметах и созданных для них тестов
elseif(isset($this->mylessons) and isset($this->lessonstests))
{
	require_once('editForms.php');
	echo getSchoolTestsByLessons($this->mylessons, $this->lessonstests);
}
//выводим информацию о классе школника и созданных для класса тестах
elseif(isset($this->myclass) and isset($this->classtests))
{
	require_once('editForms.php');
	echo getPupilClassTests($this->myclass, $this->classtests);
