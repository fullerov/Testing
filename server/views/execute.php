...
//вывод пользовательских тестов
if(is_array($this->usertests))
echo getUserTests($this->usertests);
//вывод организационных тестов
if(is_array($this->orgtests))
echo getOrgTests($this->orgtests);
//вывод университетских тестов
if(is_array($this->univertests))
echo getUniverTests($this->univertests);
//вывод школьных тестов
if(is_array($this->schooltests))
echo getSchoolTests($this->schooltests);
?>
</div>
<!--Нижний колонтитул-->
