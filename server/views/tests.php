<!--Представление тестов и их создателей-->
...
<!--Вывод контента-->
<div id="content"><? 
//выводим данные о пользователях и созданных ими тестов
if(isset($this->userstests))
{
	require_once('editForms.php');
	echo getUserTests($this->userstests);
}
//выводим данные о школах и созданых для них тестах
elseif(isset($this->schoolstests))
{
	require_once('editForms.php');
	echo getAllSchools($this->schoolstests);
}
//выводим организации и их тесты
elseif(isset($this->orgtests))
{
	require_once('editForms.php');
	echo getAllOrgTests($this->orgtests);
}
//выводим университеты и их тесты
elseif(isset($this->universtests))
{
	require_once('editForms.php');
	echo getAllUniverTests($this->universtests);
}
